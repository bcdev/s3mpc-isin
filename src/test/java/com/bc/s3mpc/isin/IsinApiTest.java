...
public class IsinApiTest {
    ...
    public void testToGlobalMap_1km() {
        final IsinAPI isinAPI = new IsinAPI();

        // front pole
        IsinPoint isinPoint = isinAPI.toGlobalMap(IsinAPI.Raster.GRID_1_KM, 0.0, 0.0);
        assertEquals(0.0, isinPoint.getX(), 1e-8);
        assertEquals(0.0, isinPoint.getY(), 1e-8);

        // Hamburg
        isinPoint = isinAPI.toGlobalMap(IsinAPI.Raster.GRID_1_KM, 9.993682, 53.551086);
        assertEquals(660163.620386195, isinPoint.getX(), 1e-8);
        assertEquals(5954615.791176178, isinPoint.getY(), 1e-8);

        // Cape of Good Hope
        isinPoint = isinAPI.toGlobalMap(IsinAPI.Raster.GRID_1_KM, -18.49755, -34.357203);
        assertEquals(-1698032.4144802324, isinPoint.getX(), 1e-8);
        assertEquals(-3820350.9733573943, isinPoint.getY(), 1e-8);

        // Green Patch
        isinPoint = isinAPI.toGlobalMap(IsinAPI.Raster.GRID_1_KM, -58.130897, -51.557058);
        ...
        isinPoint = isinAPI.toGlobalMap(IsinAPI.Raster.GRID_1_KM, -124.736636, 48.391578);
        assertEquals(-9211556.01868853, isinPoint.getX(), 1e-8);
        assertEquals(5380904.030942225, isinPoint.getY(), 1e-8);

        // close to north pole
        isinPoint = isinAPI.toGlobalMap(IsinAPI.Raster.GRID_1_KM, 116.8765, 89.45673);
    ...
    public void testToGlobalMap_500m() {
        ...
        IsinPoint isinPoint = isinAPI.toGlobalMap(IsinAPI.Raster.GRID_500_M, 0.0, 0.0);
        assertEquals(0.0, isinPoint.getX(), 1e-8);
        assertEquals(0.0, isinPoint.getY(), 1e-8);

        // Hamburg
        isinPoint = isinAPI.toGlobalMap(IsinAPI.Raster.GRID_500_M, 9.993682, 53.551086);
        assertEquals(660189.3437192842, isinPoint.getX(), 1e-8);
        assertEquals(5954615.791176178, isinPoint.getY(), 1e-8);

        // Cape of Good Hope
        isinPoint = isinAPI.toGlobalMap(IsinAPI.Raster.GRID_500_M, -18.49755, -34.357203);
        assertEquals(-1698240.2648659053, isinPoint.getX(), 1e-8);
        assertEquals(-3820350.9733573943, isinPoint.getY(), 1e-8);

        // Green Patch
        isinPoint = isinAPI.toGlobalMap(IsinAPI.Raster.GRID_500_M, -58.130897, -51.557058);
        assertEquals(-4019126.6931849453, isinPoint.getX(), 1e-8);
        assertEquals(-5732889.744073278, isinPoint.getY(), 1e-8);

        // Tatoosh island light house
        isinPoint = isinAPI.toGlobalMap(IsinAPI.Raster.GRID_500_M, -124.736636, 48.391578);
        assertEquals(-9210842.761749571, isinPoint.getX(), 1e-8);
        assertEquals(5380904.030942225, isinPoint.getY(), 1e-8);

        // close to north pole
        isinPoint = isinAPI.toGlobalMap(IsinAPI.Raster.GRID_500_M, 116.8765, 89.45673);
    ...
    public void testToGlobalMap_250m() {
        ...
        IsinPoint isinPoint = isinAPI.toGlobalMap(IsinAPI.Raster.GRID_250_M, 0.0, 0.0);
        assertEquals(0.0, isinPoint.getX(), 1e-8);
        assertEquals(0.0, isinPoint.getY(), 1e-8);

        // Hamburg
        isinPoint = isinAPI.toGlobalMap(IsinAPI.Raster.GRID_250_M, 9.993682, 53.551086);
        assertEquals(660202.2053858287, isinPoint.getX(), 1e-8);
        assertEquals(5954615.791176178, isinPoint.getY(), 1e-8);

        // Cape of Good Hope
        isinPoint = isinAPI.toGlobalMap(IsinAPI.Raster.GRID_250_M, -18.49755, -34.357203);
        assertEquals(-1697984.8025350068, isinPoint.getX(), 1e-8);
        assertEquals(-3820350.9733573943, isinPoint.getY(), 1e-8);

        // Green Patch
        isinPoint = isinAPI.toGlobalMap(IsinAPI.Raster.GRID_250_M, -58.130897, -51.557058);
        assertEquals(-4018898.6450732797, isinPoint.getX(), 1e-8);
        assertEquals(-5732889.744073278, isinPoint.getY(), 1e-8);

        // Tatoosh island light house
        isinPoint = isinAPI.toGlobalMap(IsinAPI.Raster.GRID_250_M, -124.736636, 48.391578);
        assertEquals(-9210450.571864398, isinPoint.getX(), 1e-8);
        assertEquals(5380904.030942225, isinPoint.getY(), 1e-8);

        // close to north pole
        isinPoint = isinAPI.toGlobalMap(IsinAPI.Raster.GRID_250_M, 116.8765, 89.45673);
    ...
    public void testToTileImageCoordinates_1km() {
        ...
        // front pole
        IsinPoint isinPoint = isinAPI.toTileImageCoordinates(IsinAPI.Raster.GRID_1_KM, 0.0, 0.0);
        ...
        // Hamburg
        isinPoint = isinAPI.toTileImageCoordinates(IsinAPI.Raster.GRID_1_KM, 9.993682, 53.551086);
        ...
        // Cape of Good Hope
        isinPoint = isinAPI.toTileImageCoordinates(IsinAPI.Raster.GRID_1_KM, -18.49755, -34.357203);
        ...
        // Green Patch
        isinPoint = isinAPI.toTileImageCoordinates(IsinAPI.Raster.GRID_1_KM, -58.130897, -51.557058);
        ...
        // Tatoosh island light house
        isinPoint = isinAPI.toTileImageCoordinates(IsinAPI.Raster.GRID_1_KM,  -124.736636, 48.391578);
        ...
        // close to north pole
        isinPoint = isinAPI.toTileImageCoordinates(IsinAPI.Raster.GRID_1_KM,  116.8765, 89.45673);
    ...
    public void testToTileImageCoordinates_500m() {
        ...
        // front pole
        IsinPoint isinPoint = isinAPI.toTileImageCoordinates(IsinAPI.Raster.GRID_500_M, 0.0, 0.0);
        assertEquals(-0.5, isinPoint.getX(), 1e-6);
        assertEquals(-0.5, isinPoint.getY(), 1e-6);
        assertEquals(9, isinPoint.getTile_line());
        assertEquals(18, isinPoint.getTile_col());
        ...
        // Hamburg
        isinPoint = isinAPI.toTileImageCoordinates(IsinAPI.Raster.GRID_500_M, 9.993682, 53.551086);
        ...
        // Cape of Good Hope
        isinPoint = isinAPI.toTileImageCoordinates(IsinAPI.Raster.GRID_500_M, -18.49755, -34.357203);
        ...
        // Green Patch
        isinPoint = isinAPI.toTileImageCoordinates(IsinAPI.Raster.GRID_500_M, -58.130897, -51.557058);
        ...
        // Tatoosh island light house
        isinPoint = isinAPI.toTileImageCoordinates(IsinAPI.Raster.GRID_500_M,  -124.736636, 48.391578);
        ...
        // close to north pole
        isinPoint = isinAPI.toTileImageCoordinates(IsinAPI.Raster.GRID_500_M,  116.8765, 89.45673);
    ...
    public void testToTileImageCoordinates_250m() {
        ...
        // front pole
        IsinPoint isinPoint = isinAPI.toTileImageCoordinates(IsinAPI.Raster.GRID_250_M, 0.0, 0.0);
        assertEquals(-0.5, isinPoint.getX(), 1e-6);
        assertEquals(-0.5, isinPoint.getY(), 1e-6);
        assertEquals(9, isinPoint.getTile_line());
        assertEquals(18, isinPoint.getTile_col());
        ...
        // Hamburg
        isinPoint = isinAPI.toTileImageCoordinates(IsinAPI.Raster.GRID_250_M, 9.993682, 53.551086);
        ...
        // Cape of Good Hope
        isinPoint = isinAPI.toTileImageCoordinates(IsinAPI.Raster.GRID_250_M, -18.49755, -34.357203);
        ...
        // Green Patch
        isinPoint = isinAPI.toTileImageCoordinates(IsinAPI.Raster.GRID_250_M, -58.130897, -51.557058);
        ...
        // Tatoosh island light house
        isinPoint = isinAPI.toTileImageCoordinates(IsinAPI.Raster.GRID_250_M,  -124.736636, 48.391578);
        ...
        // close to north pole
        isinPoint = isinAPI.toTileImageCoordinates(IsinAPI.Raster.GRID_250_M,  116.8765, 89.45673);
