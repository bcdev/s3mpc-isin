...
import static com.bc.s3mpc.isin.IsinAPI.Raster.GRID_1_KM;
import static com.bc.s3mpc.isin.IsinAPI.Raster.GRID_250_M;
import static com.bc.s3mpc.isin.IsinAPI.Raster.GRID_500_M;
...
public class IsinApiTest {
    ...
    public void testToGlobalMap_500m() {
        final IsinAPI isinAPI = new IsinAPI(IsinAPI.Raster.GRID_500_M);
